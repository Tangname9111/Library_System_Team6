...
import com.team6.bms.exception.NotEnoughException;
import com.team6.bms.exception.OperationFailureException;
import com.team6.bms.model.BookInfo;
import com.team6.bms.model.Borrow;
import com.team6.bms.service.BookInfoService;
import com.team6.bms.service.BorrowService;
import com.team6.bms.utils.MyResult;
import com.team6.bms.utils.MyUtils;
...
public class BorrowController {
    ...
    public Integer borrowBook(Integer userid, Integer bookid) {
        try {
            ...
            if (res2 == 0)
                throw new OperationFailureException("图书" + bookid + "更新被借信息失败");
