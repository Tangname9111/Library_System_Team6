package com.team6.bms.service.impl;

import com.mysql.cj.util.TimeUtil;
import com.team6.bms.mapper.UserMapper;
import com.team6.bms.model.User;
import com.team6.bms.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    public User login(User user) {
        return userMapper.selectByUsernameAndPasswordAndIsAdmin(user.getUsername(), user.getUserpassword(),
                user.getIsadmin());
    }
